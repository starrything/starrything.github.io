...
import { ILicenseFilters, ILicenseFilterValue } from 'src/types/license';

// ----------------------------------------------------------------------

type Props = StackProps & {
  filters: ILicenseFilters;
  onFilters: (name: string, value: ILicenseFilterValue) => void;
  //
  canReset: boolean;
...
export default function LicenseFiltersResult({
  filters,
  onFilters,
  //
  canReset,
