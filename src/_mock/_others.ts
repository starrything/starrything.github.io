...
export const _socials = [
  {
    ...
    src: '/assets/icons/footer/naver.svg',
    color: '#03C85A',
    path: 'https://blog.naver.com/starrything',
  },
  {
    value: 'instagram',
    name: 'Instagram',
    icon: 'ant-design:instagram-filled',
    src: '/assets/icons/footer/instagram-filled.svg',
    color: '#E02D69',
    path: 'https://www.instagram.com/starrything',
  },
  {
    value: 'youtube',
    name: 'Youtube',
    ...
    color: '#FF0000',
    path: 'https://www.youtube.com/@ylego89',
  },
];
